...
public class RNLockedPackage implements ReactPackage {
    /**
     * Provides the {@link RNLockedModule} to the {@link com.facebook.react.ReactApplication}.
     *
    ...
    public List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
      return Collections.singletonList(new RNLockedModule(reactContext));
    }
